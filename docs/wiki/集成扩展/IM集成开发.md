...
TreeRAG 的 IM 集成模块将企业即时通讯平台与微信生态接入知识问答管道，支持在 IM 中直接向 AI 提问并获得实时流式回答。
...
|------|:-:|:-:|:-:|
| 企业微信 | ✅ | ✅ | ✅ |
| 微信公众号（`wechat_oa`） | — | ✅（Cloud 中转） | —（P0 完整回复） |
| 个人微信（iLink `wechat`） | ✅（长轮询） | — | ✅ |
| 飞书 | ✅ | ✅ | ✅ (CardKit) |
| Lark（飞书国际版） | ✅ | ✅ | ✅ (CardKit) |
...
通过 TreeRAG Cloud 第三方平台预授权二维码，由**公众号管理员扫码**绑定后接管粉丝文字消息。发布渠道中与企业微信、个人微信分卡展示。详见 [IM集成开发文档 — 微信公众号接入](../../IM集成开发文档.md#微信公众号接入p0)。

### 个人微信接入

继续使用 iLink 扫码长轮询；产品文案为「个人微信」，不再称为公众号。
