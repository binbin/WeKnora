...
- [ ] 浏览器打开公网 IP 能访问 TreeRAG，能注册管理员
- [ ] `docker compose -f /opt/TreeRAG/docker-compose.yml ps` 全部 healthy
- [ ] `cat /opt/TreeRAG/.cloud-image-meta` 显示正确的版本
...
> TreeRAG 是腾讯系开源项目（`Tencent/TreeRAG`），如果想推动官方上架，建议在 [TreeRAG GitHub Issues](https://github.com/Tencent/WeKnora/issues) 联系维护团队，而不是个人单独申请。
