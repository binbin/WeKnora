export default {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      shareWithDescendantsTip: "선택하면 하위 기관이 이 지식베이스를 읽기 전용으로 참조할 수 있습니다. 기본값은 비공유입니다."
    },
    wiki: {
      title: "Wiki 설정",
  ...
  organization: {
    ...
    share: {
      ...
      modelShareDesc: "공유 스페이스 구성원이 모델을 사용할 수 있도록 모델을 공유 스페이스에 공유합니다.",
  ...
  tenantInvitation: {
    ...
    shareLink: {
      ...
      description: "일회용 가입 링크를 생성합니다. 누군가 링크로 가입하면 자동으로 무효화됩니다. {days}일 후 만료되며, 목록에서 언제든지 취소할 수 있습니다.",
      generate: "링크 생성",
  ...
  orgUnit: {
    sectionDescription: "플랫폼 조직 트리: 루트 조직은 시스템 관리자가 생성합니다. 멤버는 로그인 후 「조직명 스페이스」에 자동 진입하며, 본 조직과 하위 조직 사용자가 해당 스페이스를 공유합니다.",
    sectionDescriptionScoped: "소속 조직부터 하위만 관리합니다. 본급 아래에 하위 조직을 추가·조정할 수 있으며, 상위·동급은 범위 밖입니다."
  },
  dataCharts: {
