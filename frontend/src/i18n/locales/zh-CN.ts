export default {
  ...
  embedPublish: {
    ...
    stepWebhook: "事件回调",
    stepDeploy: "发布链接",
    deployIntro: "优先使用短链接直接打开；如需嵌入第三方网站，再复制下方代码。",
    ...
    deployStepWeb: "Web 直链",
    deployStepWebDesc: "短链接，浏览器直接打开即可对话，无需嵌入代码。",
    copyLink: "复制链接",
    openLink: "打开链接",
    linkCopied: "链接已复制",
    webLinkUnavailable: "暂无 Web 直链，请保存渠道后重试",
