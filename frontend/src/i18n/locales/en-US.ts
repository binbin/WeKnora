export default {
  ...
  auth: {
    ...
    usernameRequired: 'Enter your name',
    usernameMinLength: 'Name must be at least 2 Chinese characters',
    usernameMaxLength: 'Name cannot exceed 20 Chinese characters',
    usernameInvalid: 'Name must be 2-20 Chinese characters only',
  ...
  embedPublish: {
    ...
    originsHint: 'One full origin per line (e.g. https://shop.example.com); leave empty for no restriction. *.example.com subdomain wildcards supported',
...
\
  ...
  integrations: {
    ...
    chrome: {
      ...
      subtitle:
        'For self-hosted TreeRAG: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
    ...
    claw: {
      title: 'TreeRAG Skill',
      subtitle:
        'Import documents and run hybrid retrieval (vector + keyword) via the TreeRAG REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
  ...
  tenantInvitation: {
    ...
    shareLink: {
      ...
      description:
        "Generate a one-time registration link. It becomes invalid after someone joins, or after {days} days / when you revoke it from the list.",
