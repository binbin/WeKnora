export default {
  ...
  embedPublish: {
    ...
    deployStepWeb: 'Web link',
    deployStepWebDesc: 'A short URL visitors can open directly—no embed code needed.',
    copyLink: 'Copy link',
    openLink: 'Open link',
    linkCopied: 'Link copied',
    webLinkUnavailable: 'Web link is not ready yet. Save the channel and try again.',
...
\
  ...
  agentEditor: {
    ...
    publish: {
      types: {
        web: 'Login-free window',
        webDesc: 'Create shareable links for login-free use',
        api: 'API access',
      ...
      webEmpty: 'No login-free links yet',
