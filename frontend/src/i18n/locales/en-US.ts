...
\
  ...
  agentEditor: {
    ...
    im: {
      ...
      wechatOaHint: 'Requires WeKnora Cloud credentials and APP_EXTERNAL_URL',
      wechatOaQRExpired: 'Authorization QR expired, try again',
      wechatOaBinding: 'Authorizing...',
      wechatOaNeedCloud: 'Configure WeKnora Cloud credentials and public callback URL first',
      sectionChannel: 'Channel info',
