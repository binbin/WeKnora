...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 TreeRAG？',
    answers: ['TreeRAG 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['TreeRAG 是什么？', '介绍一下 TreeRAG'],
    negative_questions: ['这不是 TreeRAG', '与 TreeRAG 无关'],
    tag_name: '产品介绍',
  },
  {
