...
type TenantService interface {
	...
	// GetTreeRAGCloudCredentials returns the decrypted TreeRAGCloud credentials for the current tenant.
	GetTreeRAGCloudCredentials(ctx context.Context) *types.TreeRAGCloudCredentials
}
