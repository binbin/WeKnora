// Package feishu implements the Feishu (飞书/Lark) data source connector for TreeRAG.
//
// It syncs documents from Feishu Wiki spaces and cloud documents into TreeRAG knowledge bases.
//
// Feishu API docs:
