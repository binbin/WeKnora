// Package rss implements the RSS/Atom data source connector for TreeRAG.
//
// It syncs articles from one or more RSS/Atom/JSON feeds into a TreeRAG
...
// feed cannot redirect TreeRAG to internal services.
package rss
